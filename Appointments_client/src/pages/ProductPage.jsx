    ...
    <div className="p-6 bg-white rounded-lg shadow-sm">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="border border-gray-200 rounded-lg p-4">
          <div className="text-xs text-gray-500 uppercase font-medium">Products by sell-through rate</div>
          <div className="text-xl font-semibold mt-1">1.5%</div>
        </div>
        <div className="border border-gray-200 rounded-lg p-4">
          <div className="text-xs text-gray-500 uppercase font-medium">Products by days of inventory remaining</div>
          <div className="text-xl font-semibold mt-1">10 days</div>
        </div>
        <div className="border border-gray-200 rounded-lg p-4">
          <div className="text-xs text-gray-500 uppercase font-medium">ABC product analysis</div>
      ...
      <div className="mt-4">
        ...
        <div className="space-y-2">
          {filteredProducts.map((product) => (
            <div key={product.id} className="grid grid-cols-12 gap-4 text-sm border-b border-gray-100 pb-3 px-2 hover:bg-gray-50 items-center">
              <div className="col-span-1 flex items-center">
                <input type="checkbox" className="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500" />
              </div>
